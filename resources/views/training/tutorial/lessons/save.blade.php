...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{url('/trainings')}}/{{$data["training"]->type}}">{{$data["training"]->type}}</a>
            </li>
            <li class="breadcrumb-item"><a href="{{url('/trainingdetail')}}/{{$data["training"]->id}}">Pages</a>
            </li>
