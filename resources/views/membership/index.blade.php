                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    ...
                                    <a class="btn btn-primary" href="{{url('/membership')}}">Add Membership</a>
                                </div>
                                        ...
                                        <td>{{$value->description}}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{url('/membership/'.$value->id)}}">
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <a data-href="{{url('/deletemembership/'.$value->id)}}"   data-toggle="modal" data-target="#confirm-delete" class="dropdown-item" href="javascript:void(0);">
