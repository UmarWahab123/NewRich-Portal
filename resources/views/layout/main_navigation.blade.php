        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center tariningR" href="#"><i data-feather="folder"></i><span class="menu-title text-truncate">Training Resources</span></a>
                <ul class="menu-content">
                    ...
                    <li class="tutorials"><a class="d-flex align-items-center" href="{{ url('tutorials') }}"><i data-feather="circle"></i><span class="menu-item text-truncate">Tutorials</span></a>
                    </li>
                    <li class="course"><a class="d-flex align-items-center" href="{{ url('maintest') }}"><i data-feather="circle"></i><span class="menu-item text-truncate">Courses</span></a>
                    </li>
                    <li class="video"><a class="d-flex align-items-center" href="{{ url('maintest') }}"><i data-feather="circle"></i><span class="menu-item text-truncate">Videos</span></a>
                    </li>
                </ul>
            </li>
